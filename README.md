...
| 2026.2 | EHRWorld: A Patient-Centric Medical World Model for Long-Horizon Clinical Trajectories | - | Long-horizon EHR simulation | Patient State Modeling; Clinical Decision Making | - |
